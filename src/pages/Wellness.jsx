  ...
  return (
    <div className="page active" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="container" style={{ flex: 1, padding: '40px 20px', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
        <h1 style={{ color: '#b71c1c', borderBottom: '2px solid #e2e8f0', paddingBottom: '10px', marginBottom: '20px' }}>Wellness</h1>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
            ...
            <tbody>
              <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                ...
                <td style={{ padding: '16px', color: '#475569' }}>Wellness Articles</td>
                <td style={{ padding: '16px', color: '#475569' }}>Wellness Articles</td>
                <td style={{ padding: '16px', color: '#475569' }}>2017-09-19</td>
